 ...
 * Раньше это отображение из 14 полей было выписано вручную в четырёх местах —
 * BaselineCollector, CurrentCollector, NewsfeedSearchCollector и
 * AuthorWallCollector, — и отличалось между ними только окном сбора. Любая
 * правка (новое поле VK, другое значение по умолчанию) требовала синхронно
 * изменить все четыре копии, а пропуск одной давал бы расхождение данных между
 * окнами, которое ничем не ловится.
 *
 * ЧТО ВНУТРИ
