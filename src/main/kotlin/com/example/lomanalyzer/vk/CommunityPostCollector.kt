 ...
 * CURRENT — тематический период, BASELINE — фон до него, нужный как база
 * сравнения. Раньше это были два класса, BaselineCollector и CurrentCollector,
 * с дословно совпадающим телом: обход сообществ, чекпойнт на каждое, выгрузка
 * через PaginationManager, сохранение постов, прогресс и пауза между
 * сообществами. Отличались они лишь окном, лимитом постов и текстом прогресса,
 * поэтому любая правка сбора требовала одинаковой правки в двух файлах.
 *
 * ЧТО ВНУТРИ
