...
class JsonDataImporter(
    ...
    private fun importComments(sessionId: Int, comments: List<ImportComment>): Int {
        ...
        // ней комментарий ссылается на пост. Поиск внутри цикла перечитывал бы
        // таблицу постов сессии на каждый комментарий: на 2660 комментариев и
        // 1026 постов это 2660 выборок и порядка 2.7 млн сравнений.
     ...
     * и при totalItems = 0 показывает 0 % — одного текста этапа индикатору мало.
     *
