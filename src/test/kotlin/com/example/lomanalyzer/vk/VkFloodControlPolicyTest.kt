/*
 * НАЗНАЧЕНИЕ
 * Тесты единой политики повторов при flood control VK (ошибка 9). Раньше эта
 * логика была скопирована в трёх коллекторах и не покрывалась тестами вовсе:
 * проверить её было нельзя, не выждав реальные 10/30/60 секунд.
 *
 * ЧТО ВНУТРИ
