 ...
 * Оба случая раньше никак не отражались в результатах — сессия завершалась
 * успешно и выглядела полноценной.
 *
 * ЧТО ВНУТРИ
...
class SessionQualityEvaluatorTest {
     ...
     * качественной. Ровно это и происходило раньше — этап отрабатывал молча.
     */
    @Test
    ...
    @Test
    fun `both new indicators are primary`() {
    ...
    /** По умолчанию деградации нет — старые вызовы не начинают внезапно падать. */
    @Test
